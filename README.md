...
Hi! I'm Jacob, an undergraduate at UC Berkeley working at the intersection of **economics, statistics, and machine learning**. This repository collects a curated set of my research and case-study projects — primarily applied econometrics, causal inference, and quantitative finance.
...
### 📈 [Cross-Impact Order Flow Imbalance Analysis](research_and_case_studies/cross_impact_OFI_analysis)
...
### 🏥 [WHO Health Disparities Analysis](research_and_case_studies/WHO_analysis)
...
### 🎓 [Income Segregation & Mobility Across U.S. Colleges](research_and_case_studies/income_segregation_%26_%20mobility_across_colleges)
...
### ⚖️ [Inequality, Crime, & the Legacy of Slavery](research_and_case_studies/inequality_crime_research)
...
### 📝 [Easy Grader → Better Evaluation? A Multilevel Look at Teaching Evals](statistical_analysis/easy_grader_better_eval)
