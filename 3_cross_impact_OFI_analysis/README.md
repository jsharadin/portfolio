...
**[Interactive Tableau dashboard](https://public.tableau.com/app/profile/jacob.sharadin2431/viz/Cross-ImpactOFIAnalysis/Cross-ImpactOFIAnalysis)** — cross-impact beta heatmap, model fit by stock, PCA weights, and predictive-horizon comparison.
...
├── tableau/                    # Dashboard data extracts (CSV) + build guide
└── requirements.txt
```
